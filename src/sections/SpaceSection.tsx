...
function SpaceSection() {
  ...
  const spaceImages = [
    { id: 1, src: '/images/espacogeral.jpg', alt: 'Interior do Espaço 1' },
    { id: 2, src: '/images/espacogeral.jpg', alt: 'Interior do Espaço 2' },
    { id: 3, src: '/images/espacogeral.jpg', alt: 'Interior do Espaço 3' },
    { id: 4, src: '/images/espacogeral.jpg', alt: 'Interior do Espaço 4' },
    { id: 5, src: '/images/espacogeral.jpg', alt: 'Interior do Espaço 5' },
    { id: 6, src: '/images/espacogeral.jpg', alt: 'Interior do Espaço 6' },
  ];
